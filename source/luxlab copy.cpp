...
constexpr std::array<int, 12> bytes_per_component = {1, 1, 2, 4, 8, 1, 1, 2, 4, 8, 4, 8};
...
void print_hex_table(const std::vector<std::byte> &buffer, const std::string &filename);
...
void decode_buffer(const std::vector<std::byte> &buffer) {
    ...
    fmt::print(" Tag    |    Type   | Number | Size [bytes] | Value or address \n");
    fmt::print(" -------|-----------|--------|--------------|------------------\n");
